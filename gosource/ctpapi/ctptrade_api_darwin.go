...
/*
#cgo LDFLAGS: -L${SRCDIR}/../../libs/ctpapi -lctptrade_api
#include "cctptrade_api_darwin.h"
*/
import "C"
import (
	"os"
...
func (t *Trade) CTP_GetSystemInfoUnAesEncode(pSystemInfo *TThostFtdcClientSystemInfoType, nLen TThostFtdcSystemInfoLenType) int32 {
	pchar := C.malloc(C.size_t(nLen))
...
func (t *Trade) ReqUserLogin(pReqUserLoginField *CThostFtdcReqUserLoginField, nRequestID int) int32 {
	...
	t.CTP_GetSystemInfoUnAesEncode(&systemInfo, length)
	res := C.tReqUserLogin(t.api, (*C.struct_CThostFtdcReqUserLoginField)(unsafe.Pointer(pReqUserLoginField)), C.int(nRequestID), C.int(length), (*C.char)(unsafe.Pointer(&systemInfo[0])))
	return int32(res)
}
