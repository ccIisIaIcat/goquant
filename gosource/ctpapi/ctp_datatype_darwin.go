 ...
 * @Last Modified time: 2022-12-12 18:42:33
 */
...
const THOST_FTDC_ETR_USUAL = '1' // 一般月份
const THOST_FTDC_ETR_FNSP = '2' // 交割月前一个月上半月
const THOST_FTDC_ETR_BNSP = '3' // 交割月前一个月下半月
const THOST_FTDC_ETR_SPOT = '4' // 交割月份
