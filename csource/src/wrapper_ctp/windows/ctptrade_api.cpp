...
// 请求查询合约
DLL_EXPORT_C_DECL int WPCTP tReqQryInstrument(CThostFtdcTraderApi *api, CThostFtdcQryInstrumentField *pQryInstrument, int nRequestID){ std::cout<<"pQryInstrument->InstrumentID: "<<pQryInstrument->InstrumentID<<std::endl; return api->ReqQryInstrument(pQryInstrument, nRequestID); }
// 请求查询行情
